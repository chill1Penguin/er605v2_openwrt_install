...
if [ -z $vol_bootloader ] || [ -z $vol_tddp ] || [ -z $vol_firmware_info ] || [ -z $vol_device_info ] ; then
...
rm /tmp/bootloader.img /tmp/firmware-info.img /tmp/device-info.img /tmp/tddp.img /tmp/extra-para.img
